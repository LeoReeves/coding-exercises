...
function catDog(str) {
  catMatch = str.match(/cat/g);
  dogMatch = str.match(/dog/g);
  catCount = catMatch ? catMatch.length : 0;
  dogCount = dogMatch ? dogMatch.length : 0;
...
function endOther(strA, strB) {
  lowerA = strA.toLowerCase();
  lowerB = strB.toLowerCase();
